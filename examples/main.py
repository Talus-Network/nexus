...
def main():
    ...
    # Argument parsing
    parser = argparse.ArgumentParser(description="Run a specific example with Sui client.")
    parser.add_argument("example_name", help="The name of the example to run. Available examples: trip_planner, ig_post_planner, cli_cluster")
