...
from leftovers_chef_config import input_config, agent_configs, task_configs, init_prompt, cluster_config
...
def run_example(client, package_id, model_id, mode_owner_cap):
