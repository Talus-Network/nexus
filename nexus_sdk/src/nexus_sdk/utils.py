...
def get_sui_client_with_airdrop(rpc_url="http://localhost:9000", ws_url="ws://localhost:9000", faucet_url="http://localhost:5003/gas", keystore_path = Path("./sui.keystore")):
    ...
    if not keystore_path.exists():        
        ...
        _, address = sui_config.create_new_keypair_and_address(scheme=SignatureScheme.ED25519)
